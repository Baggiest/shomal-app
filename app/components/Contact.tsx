export function Contact() {
  return (
    <>
      <section id="contact" className="py-16 bg-gradient-to-b from-[#2d3748] to-[#1a202c] text-white">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              ...
              <div>
                <h3 className="text-xl font-bold mb-4 text-[#b89139]">شبکه های اجتماعی</h3>
                <div className="flex gap-4">
                  <a
                    href="https://www.instagram.com/shomalpirooz/"
                    target="_blank"
                  ...
                  <a
                    href="https://ir.linkedin.com/company/shomal-engineering-manufacturing-co"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-12 h-12 bg-white/10 rounded-lg flex items-center justify-center hover:bg-white/20 transition-colors"
                  >
      ...
      <footer className="bg-[#1a202c] text-gray-400 py-6">
        <div className="container mx-auto px-4 text-center">
          <p className="text-sm">
            تمامی حقوق متعلق به ماشین سازی شمال پیروز میباشد
          </p>
          <p className="text-sm mt-2">
            copyright 2024 S.E.M.C
          </p>
        </div>
      </footer>
    </>
